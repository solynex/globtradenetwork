            ...
            <div class="space-y-6">
                <div id="commercial-register-upload-section">
                    ...
                    <div class="mt-2 flex items-center space-x-2">
                        ...
                        <span id="commercial-register-filename" class="text-sm text-gray-500 truncate">No file chosen</span>
                    </div>
                </div>
                <div id="tax-card-upload-section">
                    <div class="flex items-center justify-between">
                        <label class="block text-gray-700 font-medium"><i class="fas fa-file-invoice-dollar mr-2"></i>Tax Card</label>
                        <span id="tax-card-status" class="badge"></span>
                    </div>
                    <div class="mt-2 flex items-center space-x-2">
                        ...
                        <span id="tax-card-filename" class="text-sm text-gray-500 truncate">No file chosen</span>
                    </div>
                </div>
                <div id="iban-doc-upload-section">
                    <div class="flex items-center justify-between">
                        <label class="block text-gray-700 font-medium"><i class="fas fa-university mr-2"></i>IBAN Document</label>
                        <span id="iban-doc-status" class="badge"></span>
                    </div>
                    <div class="mt-2 flex items-center space-x-2">
                        ...
                        <span id="iban-doc-filename" class="text-sm text-gray-500 truncate">No file chosen</span>
                    </div>
                </div>
            </div>
